...
class AmazonRealtimeSearch {
    ...
    private function generateSearchKeywords($dirtType) {
        $keywordMapping = [
            '油汚れ' => 'キッチン 掃除 洗剤 油汚れ マジックリン アルカリ性 換気扇 クリーナー スプレー',
            'カビ' => '浴室 掃除 洗剤 カビ取り カビキラー 塩素系 除菌 漂白 カビ除去 スプレー',
            '水垢' => '水垢 除去 洗剤 クエン酸 茂木和哉 酸性 クリーナー バス トイレ',
            'ホコリ' => 'ホコリ取り クロス マスク ワイパー モップ 掃除機 ハンディ',
            '手垢' => '手垢 除去 クロス 洗剤 中性洗剤 アルコール 除菌',
            '焦げ' => '焦げ落とし 重曹 クレンザー アルカリ性 キッチン 洗剤',
            '尿石' => '尿石 除去 酸性洗剤 サンポール トイレ クリーナー',
            '石鹸カス' => '石鹸カス 除去 浴室 洗剤 バス クリーナー アルカリ性',
            'ヤニ' => 'ヤニ取り 洗剤 アルカリ性 除去 クリーナー',
            '皮脂汚れ' => '皮脂汚れ 除去 中性洗剤 アルカリ性 洗剤'
        ];
