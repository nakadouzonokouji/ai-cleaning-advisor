...
// 🚫 静的フォールバックデータ削除 - Amazon API強制使用
// 以前はここに偽の商品価格・評価データがありましたが、
// 本物のAmazon PA-APIからリアルタイムデータを取得するため削除しました。
// 🚫 静的フォールバックデータ完全削除 - 本物のAmazon PA-API強制使用
// この変数は空にして、必ず実際のAmazon APIからデータを取得するようにします
