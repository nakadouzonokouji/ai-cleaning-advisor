...
class GeminiAPIClient {
    ...
    buildAnalysisPrompt(options = {}) {
        return `🏠 日本の家庭掃除専門AI として、この画像を詳細分析してください。

あなたは日本の家庭環境と掃除用品に精通した専門家です。
画像を見て、最適な掃除方法を提案するため以下のJSON形式で正確に分析してください：

{
    ...
    "dirtLevel": "汚れ程度",
    "description": "具体的状況説明",
    "analysisVersion": "gemini-enhanced-v2"
}

## 📍 場所の判定基準（正確に特定）
- "kitchen": キッチン・台所（コンロ、シンク、換気扇、調理台）
- "bathroom": 浴室・風呂場（浴槽、壁、床、シャワー周り）
- "toilet": トイレ（便器、床、壁、タンク周り）
- "window": 窓・ガラス（窓ガラス、サッシ、網戸）
- "floor": 床（フローリング、畳、カーペット、タイル）
- "living": リビング・居室（テーブル、ソファ、棚）
- "aircon": エアコン（本体、フィルター、吹き出し口）
- "washer": 洗濯機（ドラム、ゴムパッキン、洗剤投入口）

## 🧼 汚れ種類の精密判定
- "油汚れ": キッチンの茶色・黒い汚れ、調理油による汚れ
- "軽い油汚れ": 最近の軽い油汚れ、薄い汚れ
- "頑固な油汚れ": 長期間蓄積した厚い油汚れ、こびりつき
- "カビ": 黒い点状・線状の汚れ、湿気の多い場所
- "軽いカビ": 初期段階の薄いカビ、斑点状
- "頑固なカビ": 深く根を張った黒カビ、広範囲
- "水垢": 白い結晶状・うろこ状の汚れ
- "軽い水垢": 薄い白い跡、石鹸カス
- "頑固な水垢": 厚く蓄積した白い鱗状汚れ
- "ホコリ": 灰色の粉状汚れ、繊維くず
