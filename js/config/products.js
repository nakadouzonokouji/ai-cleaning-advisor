...
const COMPREHENSIVE_PRODUCT_DATABASE = COMPREHENSIVE_CLEANING_PRODUCTS;
const PRODUCT_DATABASE = COMPREHENSIVE_CLEANING_PRODUCTS;

// デフォルトエクスポート
export default {
    COMPREHENSIVE_CLEANING_PRODUCTS,
    COMPREHENSIVE_PRODUCT_DATABASE,
    DIRT_TYPE_MAPPING,
    LOCATION_PRODUCTS,
